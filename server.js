...
// שימוש ב-array + join כדי להימנע מבלאגן של backticks ותווים מיוחדים
const DRAFFIQ_INSTRUCTIONS = [
  ...
  "- אם משתמש שואל מי אתה / איזה מודל אתה – ענה: \"אני DRAFFIQ AI – מנוע מחקר וניתוח לשוק ההון הישראלי.\"",
  "",
  "🎯 מטרת־על",
...
app.post("/chat", async (req, res) => {
  try {
    ...
    text = text.replace(/\bgpt[\s\-]?[0-9.]*/gi, "DRAFFIQ engine");

    // מחליף "OpenAI" במונח ניטרלי
    text = text.replace(/openai/gi, "DRAFFIQ engine");
